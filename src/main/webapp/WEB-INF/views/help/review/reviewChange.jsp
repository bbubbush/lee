...
<body>
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div class="col-md-10">
				<form name="reviewChange" action="reviewChangeOk.ju">
					<table class="table table-striped table table-hover" border="1">
						<tr>
							<th colspan="2"><input type="text" name="review_subject" class="form-control" value="${dto.review_subject}"></th>
							<td>${dto.review_date}</td>
						</tr>
						<tr>
							<td colspan="3"><div class="col-md-12">
									<textarea class="form-control col-sm-5" rows="10" name="review_content" value="${dto.review_content}">${dto.review_content}</textarea>
								</div>
