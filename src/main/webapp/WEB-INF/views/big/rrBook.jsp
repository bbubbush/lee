   ...
   $(document).ready(function() {
      ...
      $.ajax({
         ...
         , success : function(rr){
            ...
            $(".empty1Seat").text(40-using1);
            var using1per = using1/40*100;
            $("#sinfo1Using").attr("aria-valuenow",using1);
            $("#sinfo1Empty").attr("aria-valuenow",40-using1);
            $("#sinfo1Using").css("width",using1per+"%");
            $("#sinfo1Empty").css("width",100-using1per+"%");
            ...
            $(".empty2Seat").text(40-using2);
            var using2per = using2/40*100;
            $("#sinfo2Using").attr("aria-valuenow",using2);
            $("#sinfo2Empty").attr("aria-valuenow",40-using2);
            $("#sinfo2Using").css("width",using2per+"%");
            $("#sinfo2Empty").css("width",100-using2per+"%");
         }
      });
                           ...
                           <ul>
                              <li>총 좌석 수 : 40석
                                 <div class="progress" style="width:450px;">
                                   <div id="sinfo1All" class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" aria-valuenow="40"
                                   aria-valuemin="0" aria-valuemax="40" style="width: 100%">
                                     <span class="sr-only">히히</span>
                                   </div>
                                 </div>
                              </li>
                              <li>사용중인 좌석 : <span class="using1Seat"></span>석
                                 <div class="progress" style="width:450px;">
                                   <div id="sinfo1Using" class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="0"
                                   aria-valuemin="0" aria-valuemax="40" style="width: 45%">
                                     <span class="sr-only">히히</span>
                                   </div>
                                 </div>
                              </li>
                              <li>사용가능 좌석 : <span class="empty1Seat"></span>석
                                 <div class="progress" style="width:450px;">
                                   <div id="sinfo1Empty" class="progress-bar progress-bar-info progress-bar-striped active" role="progressbar" aria-valuenow="0"
                                   aria-valuemin="0" aria-valuemax="40" style="width: 45%">
                                     <span class="sr-only">히히</span>
                                   </div>
                                 </div>
                     ...
                     <fieldset>
                        <legend>열람실 현황</legend>
                           <ul>
                              <li>총 좌석 수 : 40석
                                 <div class="progress" style="width:450px;">
                                   <div id="sinfo2All" class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" aria-valuenow="40"
                                   aria-valuemin="0" aria-valuemax="40" style="width: 100%">
                                     <span class="sr-only">100% Complete</span>
                                   </div>
                                 </div>
                              </li>
                              <li>사용중인 좌석 : <span class="using2Seat"></span>석
                                 <div class="progress" style="width:450px;">
                                   <div id="sinfo2Using" class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="0"
                                   aria-valuemin="0" aria-valuemax="40" style="width: 0%">
                                     <span class="sr-only">히히</span>
                                   </div>
                                 </div>
                              </li>
                              <li>사용가능 좌석 : <span class="empty2Seat"></span>석
                                 <div class="progress" style="width:450px;">
                                   <div id="sinfo2Empty" class="progress-bar progress-bar-info progress-bar-striped active" role="progressbar" aria-valuenow="0"
                                   aria-valuemin="0" aria-valuemax="40" style="width: 0%">
                                     <span class="sr-only">히히</span>
                                   </div>
                                 </div>
